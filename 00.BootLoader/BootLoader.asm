...
jmp 0x07C0:START    ; CS 세그먼트 레지스터에 0x07C0를 복사하면서, START 레이블로 이동 

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;   kangOS에 관련된 환경 설정 값
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
TOTALSECTORCOUNT:   dw 1024     ; 부트 로더를 제외한 kangOS 이미지의 크기 
...
.SCREENCLEARLOOP:                       ; 화면을 지우는 루프 
    mov byte [ es: si ], 0              ; 비디오 메모리의 문자가 위치하는 어드레스에 
                                        ; 0을 복사하여 문자를 삭제 
    mov byte [ es: si + 1 ], 0x0D       ; 비디오 메모리의 속성이 위치하는 어드레스에 
                                        ; 0x0D(검은 바탕에 마젠타)을 복사 
...
RESETDISK:                              ; 디스크를 리셋하는 코드의 시작  
    ...
    mov bx, 0x10000                     ; BX 레지스터에 0x0000을 설정하여 복사할 
...
READDATA:                               ; 디스크를 읽는 코드의 시작 
    ...
    mov byte [ SECCTORNUMBER ], 0x01    ; 섹터 번호를 다시 1로 설정  
...
PRINTMESSAGE:
    ...
    push di             ; 스택에 삽입된 값을 거내 원래 값으로 복원  
    push ax 
    push cx 
    push dx 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; 부트 로더 시작 메시지 
MESSAGE1:   db 'kangOS Boot Loader Start!!', 0  ; 출력할 메시지 정의 
