...
{ 
    ...
    if (kIsMemoryEnough() == FALSE )
    {
        ...
        kPrintString( 0, 5, "Not Enough Memory!! kangOS Requires Over "
                "64Mbyte Memory!!");
        while (1);
    }
    else 
...
{ 
    ...
    while ((DWORD) pdwCurrentAddress < 0x600000 )
    {
        *pdwCurrentAddress = 0x00; 
        ...
        // 사용하는 데 문제가 생긴 것이므로 더이상 진행하지 않고 종료 
...
{ 
    ...
    while((DWORD) pdwCurrentAddress < 0x4000000 )
    {
        *pdwCurrentAddress = 0x12345678;
        ...
        // 해당 어드레스를 사용하는 데 문제가 생긴 것이므로 더이상 진행하지 않고 종료 
