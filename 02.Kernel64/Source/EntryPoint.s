...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
START:
    mov ax, 0x20            ; IA-32e 모드 커널용 데이터 세그먼트 디스크립터를 AX 레지스터에 저장
    mov ds, ax              ; DS 세그먼트 셀렉터 설정
    mov es, ax              ; ES 세그먼트 셀렉터 설정
    mov fs, ax              ; FS 세그먼트 셀렉터 설정
    mov gs, ax              ; GS 세그먼트 셀렉터 설정

    ; 스택을 0x600000~0x6FFFFF 영역에 1MB 크기로 생성
    mov ss, ax              ; SS 세그먼트 셀렉터 설정
