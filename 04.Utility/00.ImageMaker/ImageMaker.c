...
void WriteKernelInformation( int iTargetFd, int iTotalKernelSectorCount, int iKernel64SectorCount );
...
{ 
    ...
    int iBootLoaderSize, iKernel32SectorCount;
    int iSourceSize;
    ...
    printf( "[INFO] Image file creat complete\n");
                             ...
                             int iKernel32SectorCount )
{
    ...
    if ( lPosition == -1 )
    {
        fprintf( stderr, "lseek fail. errno = %d\n", errno );
        exit( -1 );
    }
